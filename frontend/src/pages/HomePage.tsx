    ...
    <div className="space-y-8">
      <section className="panel overflow-hidden">
        <div className="grid gap-8 p-8 lg:grid-cols-[1.3fr_0.7fr] lg:p-12">
          <div>
            <div className="mb-4 inline-flex rounded-full bg-coral/10 px-4 py-2 text-sm font-bold text-coral">Flask to FastAPI migration in progress</div>
            <h1 className="max-w-3xl font-display text-4xl font-black leading-tight sm:text-5xl">
              Modern veterinary care software built around AI triage, pet records, prescriptions, and owner confidence.
            </h1>
            <p className="mt-5 max-w-2xl text-lg text-ink/70">
              PawMedic Pro upgrades the original vet-care idea into a structured FastAPI and React product with room for auth, reminders, analytics, and deployment.
            </p>
